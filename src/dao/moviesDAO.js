...
export default class MoviesDAO {
  ...
  static async getMovies({
    ...
    */
    ...
    const skippedFilms= page * moviesPerPage;
    const displayCursor = cursor.skip(skippedFilms).limit(moviesPerPage)
  ...
  static async getMovieByID(id) {
    try {
      ...
      */
      ...
      console.error(`JESUS log: ${e.toString()}`)
      throw err
